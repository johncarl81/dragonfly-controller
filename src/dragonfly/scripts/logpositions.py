...
def main():
    ...
    rospy.Subscriber("/dragonfly1/mavros/global_position/global", NavSatFix, lambda position: df1_subject.on_next(position))
    rospy.Subscriber("/dragonfly2/mavros/global_position/global", NavSatFix, lambda position: df2_subject.on_next(position))
    rospy.Subscriber("/dragonfly3/mavros/global_position/global", NavSatFix, lambda position: df3_subject.on_next(position))

    print("df1.lon, df1.lat, df1.alt, df1.value, df2.lon, df2.lat, df2.alt, df2.value, df3.lon, df3.lat, df3.alt, df3.value"
